#
#  Be sure to run `pod spec lint tootkit.podspec' to ensure this is a
...
我的自定义库，目前是测试版，里面啥都没有！
  ...
  s.homepage     = "https://github.com/appledev201888/tootkit"
  ...
  s.author             = { "bigapple" => "bigapple@uutaka.com" }
  ...
  s.source       = { :git => "https://github.com/appledev201888/tootkit.git", :tag => "#{s.version}" }
